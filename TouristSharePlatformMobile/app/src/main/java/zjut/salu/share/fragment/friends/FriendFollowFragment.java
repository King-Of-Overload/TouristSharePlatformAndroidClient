...
public class FriendFollowFragment extends RxLazyFragment {
    @Bind(R.id.swipe_friends_follow)WaveSwipeRefreshLayout refreshLayout;
    @Bind(R.id.recycle_view_friend_follow)RecyclerView recyclerView;
    @Bind(R.id.circle_progress)CircleProgressView progressView;
    @Bind(R.id.iv_loading_failed_friend_follow)ImageView loadingFailedIV;
    @Bind(R.id.iv_empty_friend_follow)ImageView emptyIV;
    ...
    public int getLayoutResId() {
        return R.layout.item_fragment_friend_follow;
    }
    ...
    public void finishCreateView(Bundle state) {
        ...
        refreshLayout.setOnRefreshListener(()->{
            ...
            @Override
            public void onCompleted() {((FriendsActivity)context).runOnUiThread(() -> refreshLayout.setRefreshing(false));}
            @Override
