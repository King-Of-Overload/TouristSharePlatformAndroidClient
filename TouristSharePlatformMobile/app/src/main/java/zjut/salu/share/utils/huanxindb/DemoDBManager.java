package zjut.salu.share.utils.huanxindb;

import android.content.ContentValues;
import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;
import zjut.salu.share.utils.huanxindb.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(CuteTouristShareConfig.getInstance().getApplicationContext());
    }
