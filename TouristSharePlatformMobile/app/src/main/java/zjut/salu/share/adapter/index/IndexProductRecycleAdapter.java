...
public class IndexProductRecycleAdapter extends AbsRecyclerViewAdapter {
    private List<Product> productList;
    private ImageLoader imageLoader;
    private DisplayImageOptions options;
    public IndexProductRecycleAdapter(RecyclerView recyclerView,List<Product> productList,ImageLoader imageLoader) {
        super(recyclerView);
    ...
    public void onBindViewHolder(ClickableViewHolder holder, int position) {
        ...
        if(holder instanceof ItemViewHolder){
            ...
            imageLoader.displayImage(RequestURLs.MAIN_URL+product.getCoverImage(),itemViewHolder.coverIV,options);
            itemViewHolder.titleTV.setText(product.getPname());
            itemViewHolder.authorTV.setText(product.getSeller().getUsername());
            itemViewHolder.item_watchTV.setText(NumberUtil.converString(product.getPclickednum()));
