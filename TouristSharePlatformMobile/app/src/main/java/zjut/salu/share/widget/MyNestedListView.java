...
public class MyNestedListView extends ListView implements View.OnTouchListener,AbsListView.OnScrollListener{
    private int listViewTouchAction;
    private static final int MAXIMUM_LIST_ITEMS_VIEWABLE = 99;

    public MyNestedListView(Context context, AttributeSet attrs) {
        super(context, attrs);
