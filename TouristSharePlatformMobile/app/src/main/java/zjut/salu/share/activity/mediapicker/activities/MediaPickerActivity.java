...
import zjut.salu.share.activity.mediapicker.CropListener;
import zjut.salu.share.activity.mediapicker.MediaItem;
import zjut.salu.share.activity.mediapicker.MediaOptions;
import zjut.salu.share.activity.mediapicker.MediaSelectedListener;
import zjut.salu.share.activity.mediapicker.imageloader.MediaImageLoader;
import zjut.salu.share.activity.mediapicker.imageloader.MediaImageLoaderImpl;
import zjut.salu.share.activity.mediapicker.utils.MediaUtils;
import zjut.salu.share.activity.mediapicker.utils.MessageUtils;
import zjut.salu.share.activity.mediapicker.utils.RecursiveFileObserver;
        ...
        if (takeVideoIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (max != Integer.MAX_VALUE) {
                ...
                if (mMediaOptions.isShowWarningVideoDuration()) {
                    ...
                    dialog.setOnOKClickListener((dialog1, which) -> startActivityForResult(takeVideoIntent,
