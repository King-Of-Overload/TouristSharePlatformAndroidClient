...
public class BottomIOSMenuDialog extends Dialog{
    public BottomIOSMenuDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public BottomIOSMenuDialog create() {
            final BottomIOSMenuDialog dialog = new BottomIOSMenuDialog(p.context, shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            ...
            View view = LayoutInflater.from(p.context).inflate(R.layout.layout_dialog_bottom_menu, null);
